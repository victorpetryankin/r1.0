...
Функция СтруктураДанныхВакансии() Экспорт
	...
	| ПричинаОткрытия",
	"",
	Перечисления.СпособНабораПерсоналаНаВакансию.ПустаяСсылка(),
...
Функция СоответствиеИмениИСинонимаРеквизитовВакансий() Экспорт
	...
	СоответствиеИмениИСинонимаРеквизитовВакансий.Вставить("Должность", "Должность");
	...
	СоответствиеИмениИСинонимаРеквизитовВакансий.Вставить("СпособНабора", "Способ набора");
