...
Процедура СоздатьВТИзмененияНачисленийПозиций(Запрос, ДанныеПозиций, ПараметрыПолучения)
	...
	ПостоянныеНачисления.Добавить(РасчетЗарплаты.НачислениеРайонныйКоэффициент());
	ПостоянныеНачисления.Добавить(РасчетЗарплаты.НачислениеСевернаяНадбавка());
	ПостоянныеНачисления.Добавить(УправлениеШтатнымРасписанием.НачисленияНадбавкаЗаВредность());
