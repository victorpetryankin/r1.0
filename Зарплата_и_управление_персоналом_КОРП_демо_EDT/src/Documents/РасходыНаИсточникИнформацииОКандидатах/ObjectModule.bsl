...
Процедура ЗаполнитьПоВакансиям(МассивВакансий)
	...
	ОбщегоНазначенияКлиентСервер.ДополнитьТаблицуИзМассива(ЭтотОбъект.Вакансии, МассивВакансий, "Вакансия");
	
	ДанныеПервойВакансии = Справочники.Вакансии.ДанныеВакансии(МассивВакансий[0]);
	ЭтотОбъект.Организация = ДанныеПервойВакансии.Организация;
