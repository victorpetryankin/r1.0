...
Процедура УстановитьСвойстваЭлементовФормы()
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ЗаработокСтраница", "Видимость", ОтчетныйГод <= 2001 Или (ОтчетныйГод >= 2010 И ОтчетныйГод < 2017));
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ДоначисленныеВзносыСтраница", "Видимость", ОтчетныйГод < 2017);
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "СведенияОбУплаченныхВзносахСтраница", "Видимость", ОтчетныйГод >= 2010 И ОтчетныйГод <= 2013);
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ЗаработокВредныеУсловияСтраница", "Видимость", ОтчетныйГод < 2017);
