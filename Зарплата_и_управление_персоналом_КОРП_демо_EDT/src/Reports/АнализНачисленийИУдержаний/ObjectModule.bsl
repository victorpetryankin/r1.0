...
Функция ЗаполнятьОбщиеИсточникиДанных(НаборыДанных)
	...
	Для Каждого НаборДанных Из НаборыДанных Цикл
		...
		ИначеЕсли ТипЗнч(НаборДанных) = Тип("НаборДанныхОбъединениеСхемыКомпоновкиДанных") Тогда
			...
			ЗаполнятьИсточникиДанных = ЗаполнятьОбщиеИсточникиДанных(НаборДанных.Элементы);
...
Процедура ИнициализироватьОтчет(КлючВарианта = "") Экспорт
	...
	Если Не ОтчетИнициализирован Тогда
		...
		ЗаполнитьОбщиеИсточникиДанных = ЗаполнятьОбщиеИсточникиДанных(СхемаКомпоновкиДанных.НаборыДанных);
