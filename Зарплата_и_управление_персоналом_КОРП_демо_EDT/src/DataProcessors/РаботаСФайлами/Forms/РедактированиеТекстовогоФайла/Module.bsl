...
Процедура СохранитьКак(Команда)
	...
	Если ВыборФайла.Выбрать() Тогда
		...
		ЗарплатаКадрыКлиент.РаботаСФайламиЗаписатьТекст(ДанныеФайла, Текст, ВыбранноеПолноеИмяФайла, КодировкаТекстаДляЗаписи);
...
Процедура ЗаписатьТекст()
	...
	ЗарплатаКадрыКлиент.РаботаСФайламиЗаписатьТекст(ДанныеФайла, Текст, ИмяОткрываемогоФайла, КодировкаТекстаДляЗаписи);
	Модифицированность = Ложь;
