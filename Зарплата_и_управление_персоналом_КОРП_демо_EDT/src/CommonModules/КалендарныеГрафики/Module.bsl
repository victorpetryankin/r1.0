...
Процедура ПриЗагрузкеКлассификатора(Идентификатор, Версия, Адрес, Обработан) Экспорт
	...
	ЗагрузитьДанныеПроизводственныхКалендарей(Версия, Адрес, Обработан);
...
Процедура ЗагрузитьДанныеПроизводственныхКалендарей(Версия, Адрес, Обработан)
	...
	РаспространитьИзмененияДанныхПроизводственныхКалендарей(ТаблицаИзменений);
