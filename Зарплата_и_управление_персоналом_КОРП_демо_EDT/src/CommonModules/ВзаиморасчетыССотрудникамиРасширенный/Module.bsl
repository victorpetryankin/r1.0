...
Функция ВедомостьНДФЛПоТаблицеЗарплат(Ведомость, ТаблицаЗарплат)
	...
	УчетФактическиПолученныхДоходов.ПоместитьВоВременныеТаблицыДвиженияРегистрацииНовойДатыДохода(
						Ведомость.Ссылка, 
						Ведомость.Движения, 
						МенеджерВременныхТаблиц, 
						Ведомость.Дата, 
						ВзаиморасчетыССотрудникамиКлиентСерверРасширенный.ВедомостьДатаВыплаты(Ведомость));
	...
	Если ЗначениеЗаполнено(Ведомость.СтатьяФинансирования) Или ЗначениеЗаполнено(Ведомость.СтатьяРасходов) Тогда
		...
		БухучетНДФЛ = ОтражениеЗарплатыВБухучетеРасширенный.БухучетНДФЛСотрудниковПоДокументамОснованиям(ТаблицаОтбораБухучетаНДФЛ, МенеджерВременныхТаблиц, Ведомость.Ссылка);
