...
Процедура СкрытьПерсональныеДанныеСубъектов(Знач Субъекты, СообщатьОбИсключениях = Ложь) Экспорт
	...
	ПараметрыОтбора.ТипСубъектов = ТипСубъектов;
...
Процедура ПолучениеСубъектовДляСкрытияПерсональныхДанных() Экспорт
	...
	Для Каждого ТипСубъекта Из ТипыСубъектов Цикл
		...
		Если ТипСубъекта = Тип("СправочникСсылка.ИдентификаторыОбъектовМетаданных") Тогда
			Продолжить;
		КонецЕсли;
		
		МетаданныеСправочника = Метаданные.НайтиПоТипу(ТипСубъекта);
...
Процедура РассчитатьДатуСкрытияПерсональныхДанныхСубъекта(Субъект) Экспорт
	...
	НастройкиСубъектов = ПрочитатьНастройкиСкрытияСубъектов(Субъект);
