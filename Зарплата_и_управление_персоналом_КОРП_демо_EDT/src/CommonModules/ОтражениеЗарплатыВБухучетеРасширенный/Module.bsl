...
//		МенеджерВременныхТаблиц, менеджер временных таблиц (необязательно).
//
...
//			* Сумма
//
Функция БухучетНДФЛСотрудниковПоДокументамОснованиям(ТаблицаУсловийОтбора, МенеджерВременныхТаблиц, ИсключаемыйРегистратор) Экспорт
	
	Если МенеджерВременныхТаблиц = Неопределено Тогда
		МенеджерВременныхТаблиц = Новый МенеджерВременныхТаблиц;
	КонецЕсли;
	ЗарплатаКадры.СоздатьПустуюВТ(МенеджерВременныхТаблиц, "РегистрНакопления.БухучетНачисленияУдержанияПоСотрудникам");
	...
	|ИЗ
	|	ВТСписокУсловий КАК ТаблицаУсловийОтбора
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ВТРегистрНакопления_БухучетНачисленияУдержанияПоСотрудникам КАК БухучетНачисленияУдержания
	|		ПО ТаблицаУсловийОтбора.ДокументОснование = БухучетНачисленияУдержания.ПервичныйРегистратор
	|			И ТаблицаУсловийОтбора.Подразделение = БухучетНачисленияУдержания.ТерриторияВыполненияРаботВОрганизации
	|			И ТаблицаУсловийОтбора.ФизическоеЛицо = БухучетНачисленияУдержания.ФизическоеЛицо
	|			И ТаблицаУсловийОтбора.МесяцНалоговогоПериода = БухучетНачисленияУдержания.ДатаПолученияДохода
