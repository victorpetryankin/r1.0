...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	// 3.4. Установить ссылки на идентификаторы объектов метаданных в настройках вариантов универсального отчета.
	Обработчик = Обработчики.Добавить();
	...
	Обработчик.Комментарий = НСтр("ru = 'Установка параметра ИсточникДанных в настройках вариантов отчета ""Универсальный отчет"".
		|Для того чтобы формировать варианты этого отчета следует дождаться завершения обработки.'");
