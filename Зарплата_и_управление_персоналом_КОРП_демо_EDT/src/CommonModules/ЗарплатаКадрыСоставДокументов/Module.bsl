...
//   * ИмяРеквизитаФизическоеЛицо                     - Строка - имя реквизита ФизическоеЛицо табличной части физические
//                                                               лица документа
...
Функция НовоеОписаниеСоставаДокумента() Экспорт
	...
	ОписаниеСостава.Вставить("ИмяРеквизитаФизическоеЛицо", "ФизическоеЛицо");
...
// Возвращает описание состава документа по метаданным, в случае хранения физических лиц в шапке документа.
//
// Возвращаемое значение
//  Структура - см. НовоеОписаниеСоставаДокумента.
//
Функция ОписаниеСоставаДокументаПоМетаданнымФизическоеЛицоВШапке(МетаданныеДокумента) Экспорт
	...
	Если ПолеСотрудник <> Неопределено
		...
		Если ПолеФизическоеЛицо <> Неопределено 
			И ПолеСотрудник <> Неопределено Тогда
...
Процедура ЗаполнитьРегистрСоставДокументовЗарплатаКадры(Источник, СотрудникиФизическиеЛица) Экспорт
...
Процедура ЗаполнитьТабличнуюЧастьФизическиеЛицаДокумента(Источник, ОписаниеДокумента, ФизическиеЛица) Экспорт
	...
	ИмяРеквизитаФизическоеЛицо = ОписаниеДокумента.ИмяРеквизитаФизическоеЛицо;
