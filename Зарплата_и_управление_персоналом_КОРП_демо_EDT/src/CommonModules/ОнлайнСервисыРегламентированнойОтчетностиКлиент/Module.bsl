...
Процедура АктуализироватьСлужебнуюИнформациюМеханизмаОнлайнСервисовРОПриНеобходимости(Форма) Экспорт
	...
	Если РазрешитьДоступВИнтернет = Неопределено ИЛИ РазрешитьДоступВИнтернет = Ложь Тогда
		Если ПараметрыИНастройки.ЗапроситьПодтверждениеДоступаВИнтернет Тогда
...
Процедура АктуализироватьСлужебнуюИнформациюМеханизмаОнлайнСервисовРОПриНеобходимостиЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	Если НЕ СтандартныеПодсистемыКлиент.ПараметрыРаботыКлиента().РазделениеВключено И ИнтернетПоддержкаПользователейКлиентСервер.ДоступноПодключениеИнтернетПоддержки() И Форма <> Неопределено Тогда
