...
Процедура ОграничитьРегистрациюОбъектаПоУправленческойОрганизации(ИмяПланаОбмена, Отказ, ТекстЗапроса, ПараметрыЗапроса, ИспользоватьКэш, Выгрузка, Объект, СтандартнаяОбработка) Экспорт
