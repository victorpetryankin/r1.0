...
//
Функция АктуальныйОтчет(ИсточникОтчета, Организация, ПериодДекларации, РегистрацияВНалоговомОргане = Неопределено) Экспорт
...
Процедура ЗаполнитьСсылкиНаРеглОтчеты(ПараметрыРеглОтчетов, ОтборПоВыбраннойФормеРеглОтчета = Ложь) Экспорт
	...
	|	ПараметрыРеглОтчетов.КорректирующийОтчет КАК КорректирующийОтчет,
...
Функция СформироватьАвтоматическиРеглОтчет6НДФЛФормаОтчета2017Кв4(ИсточникОтчета, ИмяФормыОтчета, Организация, ДатаНачала, ДатаОкончания, КорректирующийОтчет, ПараметрыАвтоФормирования)
	...
	Возврат ЗаписатьРеглОтчет6НДФЛФормаОтчета2017Кв4(ИсточникОтчета, ИмяФормыОтчета,
...
Функция ЗаписатьРеглОтчет6НДФЛФормаОтчета2017Кв4(ИсточникОтчета, ИмяФормыОтчета, Организация, ДатаНачала, ДатаОкончания, РазделыОтчета, ДанныеРеглОтчета, СсылкаНаСохрРеглОтчет = Неопределено)
	...
	ЗаполнитьСведенияОбОрганизацииРеглОтчет6НДФЛФормаОтчета2017Кв4(Организация, РазделыОтчета, ДанныеРеглОтчета.ДатаПодписи, ДатаОкончания);
...
Процедура ЗаполнитьСведенияОбОрганизацииРеглОтчет6НДФЛФормаОтчета2017Кв4(Организация, РазделыОтчета, ДатаПодписи, ДатаОкончания)
	
	ПБОЮЛ = НЕ РегламентированнаяОтчетностьВызовСервера.ЭтоЮридическоеЛицо(Организация);
	
	РазделыОтчета.Титульный.Данные.ПоМесту = ?(ПБОЮЛ, "120", "214");
