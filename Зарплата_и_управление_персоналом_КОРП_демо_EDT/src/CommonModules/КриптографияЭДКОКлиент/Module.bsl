...
Процедура Зашифровать(ОповещениеОЗавершении, СертификатОтправителя, ИмяФайлаДанных, СертификатПолучателя, ПараметрыКриптографии, 
						КаталогРезультатаИлиАдреса = Неопределено, ВыводитьСоообщения = Истина, МенеджерКриптографии = Неопределено) Экспорт
	...
	КриптографияЭДКОСлужебныйКлиент.Зашифровать(
		...
		ПараметрыКриптографии, КаталогРезультатаИлиАдреса, ВыводитьСоообщения, МенеджерКриптографии);
...
Процедура РасшифроватьФайл(ОповещениеОЗавершении, СертификатПолучателя, ИмяЗашифрованногоФайла, ПубличныйКлючОтправителя, СессионныйКлюч,
	...
	КриптографияЭДКОСлужебныйКлиент.РасшифроватьФайл(
		...
		ИнициализационныйВектор, ИмяФайлаИлиРасширениеИлиАдрес, ВыводитьСоообщения, МенеджерКриптографии);
